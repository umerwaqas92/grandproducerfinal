...
class CartItemMainBean {
  ...
  CartItemMainBean(this.status, this.message, this.total_price,
      this.total_items, this.delivery_charge, this.store_details, this.data);
