...
class AddToCartMainModel{
  ...
  AddToCartMainModel(this.status, this.message, this.total_price, this.delivery_charge, this.cart_items);
  ...
  factory AddToCartMainModel.fromJson(dynamic json){
    ...
    return AddToCartMainModel(json['status'], json['message'], json['total_price'], json['delivery_charge'], ct);
  }

  @override
  String toString() {
    return '{status: $status, message: $message, total_price: $total_price, delivery_charge: $delivery_charge, cart_items: $cart_items}';
  }
}
