...
class ProductDataModel {
  ...
  @override
  String toString() {
    return 'ProductDataModel{pId: $pId, varientId: $varientId, stock: $stock, storeId: $storeId, mrp: $mrp, price: $price, productId: $productId, quantity: $quantity, unit: $unit, baseMrp: $baseMrp, basePrice: $basePrice, description: $description, varientImage: $varientImage, ean: $ean, approved: $approved, addedBy: $addedBy, catId: $catId, productName: $productName, productImage: $productImage, hide: $hide, qty: $qty, tags: $tags, varients: $varients}';
  }
}
